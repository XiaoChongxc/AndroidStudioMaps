...
/**
 * Created by androiddev on 2017/6/12 0012.
 * email:androiddev@zuhaoche.cn
 * 手写签名
 */
...
public class LinePathView extends View {
    ...
    public boolean isChildTouch = false;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        Log.d("TAG", "onTouchEvent: =================" + Const.hanlderAction(event.getAction()));
