        ...
        switch (i) {
            case NETWORK_ERROR:
                ...
                if (isConnectInternet(context)) {
                    ...
                    img.setBackgroundResource(R.drawable.ic_load_error);
                } else {
                    tv.setText(R.string.error_view_network_error_click_to_refresh);
                    img.setBackgroundResource(R.drawable.ic_load_bad_network);
                }
            ...
            case NODATA:
                ...
                img.setBackgroundResource(R.drawable.ic_load_no_data);
                img.setVisibility(View.VISIBLE);
                animProgress.setVisibility(View.GONE);
                setTvNoDataContent();
                clickEnable = true;
