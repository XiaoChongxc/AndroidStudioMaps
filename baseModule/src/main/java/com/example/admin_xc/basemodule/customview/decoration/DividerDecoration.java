package com.example.admin_xc.basemodule.customview.decoration;
...
//            headerCount = ((Adapter) parent.getAdapter()).getHeaderCount();
//            footerCount = ((Adapter) parent.getAdapter()).getFooterCount();
        }
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        int orientation = 0;
        int headerCount = 0,footerCount = 0,dataCount=0;
