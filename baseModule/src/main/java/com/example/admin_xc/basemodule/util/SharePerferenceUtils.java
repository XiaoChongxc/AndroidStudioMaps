...
public class SharePerferenceUtils {
    ...
    private SharePerferenceUtils(Context context) {
        mSharedPreferences = context.getSharedPreferences("WZB",
    ...
    public void saveOAuth(Object member) {
        ...
        try {
            ...
            putString(Const.OAUTH, oAuth_Base64);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    public void saveOAuth(Object member,String key) {
        // 创建字节输出流
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        try {
            // 创建对象输出流，并封装字节流
    ...
    public Object getOAuth() {
        String memberBase64 = mSharedPreferences.getString(Const.OAUTH, "");
        //读取字节
        ...
        try {
            ...
            e.printStackTrace();
            removeKey(Const.IS_LOGIN);
            removeKey(Const.OAUTH);
            return null;
        }
        return member;
    }

    public Object getOAuth(String key) {
        String memberBase64 = mSharedPreferences.getString(key, "");
        //读取字节
        byte[] base64 = Base64.decode(memberBase64, Base64.DEFAULT);
        Object member = null;
        //封装到字节流
